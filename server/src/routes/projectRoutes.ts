...
import {newProject, getAllProjects, updateProject,deleteProject, getActivityLogs} from "../controllers/projectController.js"
...
projectRouter.get('/:projectId/activity-log', authenticate, getActivityLogs );
